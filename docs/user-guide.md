...
3. **Points réalisés** : saisir le total de points du camp attaquant (0 à 91, les demi-points comme 40,5 ou 40.5 sont acceptés)
...
| Victoire en solo | Spiderman Pointing | Très élevé |
| Victoire en garde-contre | Chris Pratt "Wow" (GIF) | Élevé |
| Victoire serrée (marge ≤ 5 pts) | Sweating Jordan Peele | Élevé |
...
L'application propose un système de **35 badges** (succès) que les joueurs débloquent automatiquement au fil de leurs parties.
...
Sur la page **Statistiques d'un joueur** (accessible via Stats → clic sur un joueur), une section **Badges (X/35)** affiche :
...
La page **Aide** (`/aide`) contient une section **Badges** listant l'ensemble des 34 badges visibles, regroupés par catégorie (Progression, Performance, Fun, Social), avec pour chacun l'icône, le nom et la condition d'obtention. Le badge secret n'y figure pas. Cette section est accessible sans nécessiter de données joueur.
...
> **Demi-points** : si le décompte donne un nombre à ½ point (ex : 40,5), le demi-point va au **camp gagnant** (règle FFT). Exemple : 40,5 pts avec 2 oudlers → l'attaque n'atteint pas 41, elle perd → le ½ point va à la défense → 40 pts comptés.
